...
public class TimelessCorpseModel extends EntityModel<TimelessCorpseRenderState>
{
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Right_Arm_r1 = Right_Arm.addOrReplaceChild("Right_Arm_r1", CubeListBuilder.create().texOffs(40, 16).addBox(-4.0F, -12.0F, 0.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 22.0F, 9.0F, 0.1745F, 0.0F, 0.0F));
        ...
        PartDefinition Left_Arm_r1 = Left_Arm.addOrReplaceChild("Left_Arm_r1", CubeListBuilder.create().texOffs(32, 48).addBox(-4.0F, -12.0F, 0.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, 20.0F, -2.0F, -0.6378F, -0.1582F, -0.2095F));
