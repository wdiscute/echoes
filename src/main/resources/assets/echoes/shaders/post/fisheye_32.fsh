...
const float BLUR_STRENGTH = 32.0;

// Where the blur begins.
//
// 0.0 = starts at center
// 0.5 = starts halfway toward the border
// 0.75 = only outer 25%
// 0.9 = only very edge
const float BLUR_START = 0.7;

// Controls how quickly the blur ramps up.
//
// 1.0 = linear
// 2.0 = gradual
// 3.0+ = mostly sharp, then rapidly blurs
